...
function descuento(){
    ...
    let totalCompra=0;
    // Solicitamos valores
    ValorCompra=parseInt(prompt("Ingrese el valor de su compra "));
    let tipoDescuento=parseInt(prompt("Escribe 1 si el descuento es del 20%, 2 si el descuento es del 30% o 3 si el descuento es del 50%"));
    //Realizamos las operaciones
    if (tipoDescuento ===1) {
        descuento=(20/100)*ValorCompra;
        
    } else if(tipoDescuento===2) {
        descuento=(30 /100) * ValorCompra;
    }else{
        descuento=(50/100) * ValorCompra;
    }
